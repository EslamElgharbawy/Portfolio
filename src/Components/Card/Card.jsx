export default function Card({ icon, projects, title, body }) {
  return (
    <>
      <div className="Card px-5 min-w-[410px] mb-20">
        <div className="Card_sahdow relative rounded-[20px] bg-[linear-gradient(180deg,rgba(255,255,255,0)_12.5%,#fff_100%)] shadow-2xl px-9 pb-10 py-16">
