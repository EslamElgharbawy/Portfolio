import project1 from "../../assets/images/p3.jpg";
import project2 from "../../assets/images/p2.jpg";
import project3 from "../../assets/images/p1.jpg";
export default function Projects() {
  return (
    <>
      <section id="Projects" className="xl:py-[150px]">
          ...
          <div className="grid grid-cols-3">
            <div className="">
              ...
              <div>
                <a
                  href=""
                  className="text-white relative overflow-hidden block"
                >
                  <div className="min-h-[200px]">
                    <img src={project1} alt="" className="w-full" />
                  </div>
                  <div className="absolute bottom-8 left-8 font-medium ">
                    <h1 className="font-Lexend text-[28px] ">First Project</h1>
                    <span className="flex items-center gap-4">
                      <p className="Demo relative font-Jost w-fit uppercase">
                        View Work
                      </p>
                      <svg
                        width="5"
            ...
            <div className="">
              <a href="" className="text-white relative overflow-hidden block">
                <div className="min-h-[200px]">
                  <img src={project2} alt="" className="w-full" />
                </div>
                <div className="absolute bottom-8 left-8">
                  <h1 className="font-Lexend text-[28px] font-medium ">
                    First Project
                  </h1>
                  <p className="font-Jost">View Work</p>
                </div>
              </a>
            </div>
