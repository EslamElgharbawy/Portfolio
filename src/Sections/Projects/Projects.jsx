import project1 from "../../assets/images/flat-devices-mockup.png";
import project2 from "../../assets/images/google-pixelbook-mockup (3).png";
        ...
        <div className="xl:mx-[159px]">
          <div>
            <div className="mb-[50px] xl:mb-[72px]">
              ...
              <div className="section_Header xl:mb-10">
            ...
            <div>
              ...
              >
                <SwiperSlide>
                  <ProjectCard
                    Link={"https://movies-self-tau.vercel.app/"}
                    project_image={project1}
                    project_name={"VibeCinema"}
                    description={"Movie Streaming Web App"}
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <ProjectCard
                    Link={"https://e-commerce-pi.vercel.app/"}
                    project_image={project2}
                    project_name={"FreshCart"}
                    description={"E-commerce React Store"}
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <ProjectCard
                    Link={"https://social-app-seven-kappa.vercel.app/"}
                    project_image={project3}
                    project_name={"Social App"}
                    description={"Social App Platform"}
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <ProjectCard
                    Link={"https://yummy-project-zeta.vercel.app/"}
                    project_image={project4}
                    project_name={"Yummy"}
                    description={"Modern Responsive Food Website"}
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <ProjectCard
                    Link={"https://note-app-dusky-six.vercel.app/"}
